			...
			<fieldset class="fieldset white">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjInstaller&amp;action=pjActionChange" method="post" id="frmChangeLogin" class="i-form" autocomplete="off">
					...
					<p>
						...
						<span>
							<input type="text" name="license_key" class="pj-form-field w400" data-msg-required="Licence key is required" autocomplete="off" maxlength="255" value="uvFW9nTYWAVS6756dfgs234fasQWV>LTYBbsdcv20MnsdfsASDQBgnTYJn"/>
						</span>
					</p>
