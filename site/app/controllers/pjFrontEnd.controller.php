        ...
        if ($this->isXHR() || isset($_GET['_escaped_fragment_'])) {
            ...
            if ($_GET['pickup_id'] != $_GET['return_id']) {
                ...
                if (isset($_GET['is_return']) && $_GET['is_return'] == 'T') {
                    ...
                    $return_bus_id_arr = $pjBusModel->getBusIds($date, $pickup_id, $return_id, true);
...
//            vd($location_arr);
    ...
    public function pjActionConfirmLiqPay() {
        ...
        if ($response !== FALSE && $response['status'] === 'OK') {
            ...
            //sending messages
            // $send = mail( $set_message['to'], $set_message['subject'], $set_message['message'], iconv ('utf-8', 'windows-1251', $set_message['headers']) );
