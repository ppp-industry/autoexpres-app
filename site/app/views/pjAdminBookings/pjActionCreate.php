...
if (isset($tpl['status']))
{
	...
	include_once PJ_VIEWS_PATH . 'pjLayouts/elements/menu_booking.php';
		...
		<div id="tabs">
			...
			<div id="tabs-2">
                ...
                <p>
					...
					<span class="inline-block">
						<input type="text" name="passport" id="passport" class="pj-form-field w250<?php echo $tpl['option_arr']['o_bf_include_passport'] == 3 ? ' required' : NULL; ?>" />
					</span>
                </p>
                <p>
                    <label class="title"><?php __('lblProdLocation'); ?>:</label>
					<span class="inline-block">
						<input type="text" name="prod_location" id="prod_location" class="pj-form-field w250<?php echo $tpl['option_arr']['o_bf_include_passport'] == 3 ? ' required' : NULL; ?>" />
					</span>
                </p>
				<p>
