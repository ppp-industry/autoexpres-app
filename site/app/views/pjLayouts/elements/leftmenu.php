...
<div class="leftmenu-middle">
    <ul class="menu">
        ...
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminBusStop&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdminBusStop' ? 'menu-focus' : NULL; ?>"><span style="background: url(/app/web/img/backend/bus_stop.png) no-repeat;" >&nbsp;</span>Зупинки</a></li>
        <?php
