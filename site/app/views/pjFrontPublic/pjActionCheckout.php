								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<select id="bsPaymentMethod_<?php echo $_GET['index'];?>" name="payment_method" class="form-control required">
											...
											{
												//echo "<script>console.log ('"; print_r (__('payment_methods', true, false)); echo "');</script>";
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<div class="pjBsCaptcha">
											<input type="text" name="captcha" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_captcha'] == 3) ? ' required' : NULL; ?>" maxlength="6" autocomplete="off"/>
											<img src="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjFrontEnd&action=pjActionCaptcha&rand=<?php echo rand(1, 9999); ?>" alt="Captcha" style="border: solid 1px #E0E3E8;"/>
										</div><!-- /.pjBsCaptcha -->
