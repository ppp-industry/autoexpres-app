				...
				<form id="bsSelectSeatsForm_<?php echo $_GET['index'];?>" action="" method="post">
						...
						{ 
							...
							<div class="panel panel-default pjBsSeats bsBusContainer">
								...
								<header class="panel-heading pjBsSeatsHead">
									<div class="row">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-8">
											<p class="panel-title pjBsSeatsTitle">Рейс</p><!-- /.panel-title pjBsSeatsTitle -->
								...
								<ul class="list-group pjBsListBusses">
									...
									{ 
										if ($bus['ticket_arr'][0]['price'] == '') continue;
										...
										<li class="list-group-item">
											<div id="bsRow_<?php echo $bus['id'];?>" class="row bsRow<?php echo isset($booked_data) && $booked_data['bus_id'] == $bus['id'] ? ' bsFocusRow' : null;?>">
												...
												<div class="col-lg-6 col-lg-offset-4 col-md-6 ol-md-offset-4 col-sm-6 col-xs-12">
													<div class="row">
														<?php
														...
														for($i = 0; $i < $tpl['ticket_columns']; $i++)
														{
															if(isset($ticket_arr[$i]))
															{
																...
																if($ticket['price'] != '')
																{
                                                                    ...
                                                                    <?if ($STORE['is_return'] == 'F'){?>
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 buttonCheckout">
                                                                            <button type="button" class="bsBtnCheckout_<?php echo $_GET['index'];?> btn btn-primary"><?php __('front_button_checkout'); ?></button>
                                                                        </div>
						...
						<div class="pjBsFormBody">
							...
							<div class="panel panel-default pjBsSeats bsBusContainer">
								...
								<ul class="list-group pjBsListBusses">
									...
									{ 
										if ($return_bus['ticket_arr'][0]['price'] == '') continue;
										...
										<li class="list-group-item">
											<div id="bsReturnRow_<?php echo $bus['id'];?>" class="row bsReturnRow bsReturnRow_<?php echo $bus['id'];?><?php echo isset($booked_data) && $booked_data['bus_id'] == $bus['id'] ? ' bsFocusRow' : null;?>">
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-8">
													...
													<?if ($return_bus['route']){?>
														<p class="busRoute">
															Рейс: <?php echo $return_bus['route'];?>
														</p>
													<?}?>
														...
														for($i = 0; $i < $tpl['return_ticket_columns']; $i++)
														{
															if(isset($ticket_arr[$i]))
															{
																...
																<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																	<div class="form-group">
																		<div class="input-group">
																			<select id="return_ticket_cnt_<?php echo $return_bus['id'] . '_' . $ticket['ticket_id'];?>" name="return_ticket_cnt_<?php echo $ticket['ticket_id'];?>" class="form-control bsReturnTicketSelect bsTicketSelect bsReturnTicketSelect-<?php echo $return_bus['id'];?>" data-set="<?php echo !empty($return_bus['seats_map']) ? 'T' : 'F';?>" data-pickup="<?php echo $bus['id']; ?>" data-pickup-bus="<?php echo $bus['id']; ?>" data-bus="<?php echo $return_bus['id']; ?>" data-price="<?php echo $ticket['price'];?>">
																				<?php
																				for($j = 0; $j <= $seats_avail; $j++)
																				{
																...
																<? if ($STORE['is_return'] == 'F'){?>
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 buttonCheckout">
                                                                        <button type="button" class="bsBtnCheckout_<?php echo $_GET['index'];?> btn btn-primary extraTop"><?php __('front_button_checkout'); ?></button>
                                                                    </div>
                                                                <?}?>
																<?php
															}
					...
					<footer class="pjBsFormFoot">
						...
						<div class="clearfix pjBsFormActions">
							...
							{ 
								?>
								<button type="button" id="bsBtnCheckout_<?php echo $_GET['index'];?>" class="bsBtnCheckout_<?php echo $_GET['index'];?> btn btn-primary pull-right"><?php __('front_button_checkout'); ?></button>
								<?php
							} 
							?>
