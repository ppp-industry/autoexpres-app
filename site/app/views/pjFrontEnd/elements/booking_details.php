...
<input type="hidden" name="return_sub_total" value="<?php echo $return_sub_total;?>" />
<input type="hidden" name="return_tax" value="<?php echo $return_tax;?>" />
<input type="hidden" name="return_total" value="<?php echo $return_total;?>" />
<input type="hidden" name="return_deposit" value="<?php echo $return_deposit;?>" />