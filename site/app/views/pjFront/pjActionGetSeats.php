...
if(!empty($tpl['bus_type_arr']))
{
	...
	if (is_file($map))
	{
		...
		?>
		<div class="bsMapHolder" style="height: <?php echo $size[1] + 20;?>px;">
			<img id="map" src="<?php echo PJ_INSTALL_FOLDER . $tpl['bus_type_arr']['seats_map']; ?>" alt="" style="margin: 0; border: none; position: absolute; top: 0; left: 0; z-index: 500" />
			<?php
