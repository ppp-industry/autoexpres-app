...
class pjToolkit {
     ...
     * @return string
     */
    public static function formatCurrencySign($price, $currency, $separator = "",$html = true) {
        ...
        return $price . $separator . self::getCurrencySign($currency,$html);
    }
    ...
    private static function getCurrencyData() {
        ...
        if (isset($GLOBALS['CONFIG'], $GLOBALS['CONFIG']['currencies']) && is_array($GLOBALS['CONFIG']['currencies']) && !empty($GLOBALS['CONFIG']['currencies'])) {
